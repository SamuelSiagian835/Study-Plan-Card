...
if (isset($_GET['nim'])) {
    ...
    // Prepare and execute SQL query to fetch the selected courses for the student
    $query = "SELECT course.* FROM course INNER JOIN student_course ON course.id = student_course.course_id WHERE student_course.student_id = :nim ORDER BY course.id ASC";
    ...
    echo "<h2>NIM: $nim</h2>";
    echo "<table>";
    echo "<tr><th>ID</th><th>Course Name</th><th>Credit Hours</th></tr>";
